...
const About = () => {
  return (
    <section className="overflow-hidden pt-20 pb-12 lg:pt-[120px] lg:pb-[90px] bg-white dark:bg-dark mt-[28rem] p-[8rem]">
          ...
          <div className="flex flex-wrap items-center justify-between -mx-4">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="mt-10 lg:mt-0">
                ...
                Fast & Furious Transcription
                </h2>
                <p className="mb-5 text-base text-body-color dark:text-dark-6">
                 Don't watch the clock; do what it does. Keep going with the speedy transcription.
                </p>
                <a
